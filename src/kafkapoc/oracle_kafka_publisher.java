...
import kafkapoc.row1Struct;

public class oracle_kafka_publisher {
	
	public static final String TOPIC_NAME="topic_rxlogix1";
	//public static final String BOOTSTRAP_SERVERS="10.100.22.5:9092";
	public static final String BOOTSTRAP_SERVERS="localhost:9092";
	
	//Starting point of the publisher
	public static void main(String[] args){
		
		System.out.println(new Date().toString()+": Started oracle-kafka publisher ..");
		oracle_kafka_publisher okp = new oracle_kafka_publisher();
		Producer<String,row1Struct> producer = null;
		...
		try{
			...
			//Initialize Kafka
			producer = okp.initKafkaPublisher();
		...
		System.out.println(new Date().toString()+": Successfully published");		
	...
	public void publishSourceDb(java.sql.Statement stmt,Producer<String,row1Struct> producer){
		...
		String dbquery_tOracleInput_1 = "SELECT \n  PVA_STAGE.S_CASE_MASTER.ENTERPRISE_ID, \n  PVA_STAGE.S_CASE_MASTER.CASE_ID, \n  PVA_STAGE.S_CASE_MASTER.CASE_NUM, \n  PVA_STAGE.S_CASE_MASTER.REV, \n  PVA_STAGE.S_CASE_MASTER.WORKFLOW_SEQ_NUM, \n  PVA_STAGE.S_CASE_MASTER.LAST_WORKFLOW_SEQ_NUM, \n  PVA_STAGE.S_CASE_MASTER.CREATE_TIME, \n  PVA_STAGE.S_CASE_MASTER.INIT_REPT_DATE, \n  PVA_STAGE.S_CASE_MASTER.\"USER_ID\", \n  PVA_STAGE.S_CASE_MASTER.LAST_UPDATE_TIME, \n  PVA_STAGE.S_CASE_MASTER.LAST_UPDATE_USER_ID, \n  PVA_STAGE.S_CASE_MASTER.REQUIRES_FOLLOWUP, \n  PVA_STAGE.S_CASE_MASTER.FOLLOWUP_DATE, \n  PVA_STAGE.S_CASE_MASTER.OWNER_ID, \n  PVA_STAGE.S_CASE_MASTER.STATE_ID, \n  PVA_STAGE.S_CASE_MASTER.COUNTRY_ID, \n  PVA_STAGE.S_CASE_MASTER.LANG_ID, \n  PVA_STAGE.S_CASE_MASTER.PRIORITY, \n  PVA_STAGE.S_CASE_MASTER.SITE_ID, \n  PVA_STAGE.S_CASE_MASTER.SERIOUSNESS, \n  PVA_STAGE.S_CASE_MASTER.RPT_TYPE_ID, \n  PVA_STAGE.S_CASE_MASTER.LAST_STATE_ID, \n  PVA_STAGE.S_CASE_MASTER.ASSESSMENT_NEEDED, \n  PVA_STAGE.S_CASE_MASTER.PRIORITY_OVERRIDE, \n  PVA_STAGE.S_CASE_MASTER.SID, \n  PVA_STAGE.S_CASE_MASTER.SAFETY_DATE, \n  PVA_STAGE.S_CASE_MASTER.NORMAL_TIME, \n  PVA_STAGE.S_CASE_MASTER.MAX_TIME, \n  PVA_STAGE.S_CASE_MASTER.REPORT_SCHEDULING, \n  PVA_STAGE.S_CASE_MASTER.PRIORITY_ASSESSMENT, \n  PVA_STAGE.S_CASE_MASTER.CLOSE_USER_ID, \n  PVA_STAGE.S_CASE_MASTER.CLOSE_DATE, \n  PVA_STAGE.S_CASE_MASTER.CLOSE_NOTES, \n  PVA_STAGE.S_CASE_MASTER.DATE_LOCKED, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_1, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_2, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_3, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_4, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_5, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_6, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_7, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_8, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_9, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_10, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_11, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_12, \n  PVA_STAGE.S_CASE_MASTER.UD_DATE_1, \n  PVA_STAGE.S_CASE_MASTER.UD_DATE_2, \n  PVA_STAGE.S_CASE_MASTER.UD_DATE_3, \n  PVA_STAGE.S_CASE_MASTER.UD_DATE_4, \n  PVA_STAGE.S_CASE_MASTER.UD_DATE_5, \n  PVA_STAGE.S_CASE_MASTER.UD_DATE_6, \n  PVA_STAGE.S_CASE_MASTER.UD_DATE_7, \n  PVA_STAGE.S_CASE_MASTER.UD_DATE_8, \n  PVA_STAGE.S_CASE_MASTER.UD_DATE_9, \n  PVA_STAGE.S_CASE_MASTER.UD_DATE_10, \n  PVA_STAGE.S_CASE_MASTER.UD_DATE_11, \n  PVA_STAGE.S_CASE_MASTER.UD_DATE_12, \n  PVA_STAGE.S_CASE_MASTER.UD_NUMBER_1, \n  PVA_STAGE.S_CASE_MASTER.UD_NUMBER_2, \n  PVA_STAGE.S_CASE_MASTER.UD_NUMBER_3, \n  PVA_STAGE.S_CASE_MASTER.UD_NUMBER_4, \n  PVA_STAGE.S_CASE_MASTER.UD_NUMBER_5, \n  PVA_STAGE.S_CASE_MASTER.UD_NUMBER_6, \n  PVA_STAGE.S_CASE_MASTER.UD_NUMBER_7, \n  PVA_STAGE.S_CASE_MASTER.UD_NUMBER_8, \n  PVA_STAGE.S_CASE_MASTER.UD_NUMBER_9, \n  PVA_STAGE.S_CASE_MASTER.UD_NUMBER_10, \n  PVA_STAGE.S_CASE_MASTER.UD_NUMBER_11, \n  PVA_STAGE.S_CASE_MASTER.UD_NUMBER_12, \n  PVA_STAGE.S_CASE_MASTER.DELETED, \n  PVA_STAGE.S_CASE_MASTER.DUE_SOON, \n  PVA_STAGE.S_CASE_MASTER.GLOBAL_NUM, \n  PVA_STAGE.S_CASE_MASTER.PRIORITY_DATE_ASSESSED, \n  PVA_STAGE.S_CASE_MASTER.LAM_ASSESS_DONE, \n  PVA_STAGE.S_CASE_MASTER.E2B_WW_NUMBER, \n  PVA_STAGE.S_CASE_MASTER.WORKLIST_OWNER_ID, \n  PVA_STAGE.S_CASE_MASTER.SUSAR, \n  PVA_STAGE.S_CASE_MASTER.LAST_UPDATE_EVENT, \n  PVA_STAGE.S_CASE_MASTER.INITIAL_JUSTIFICATION, \n  PVA_STAGE.S_CASE_MASTER.FORCE_SOON, \n  PVA_STAGE.S_CASE_MASTER.DUE_SOON_J, \n  PVA_STAGE.S_CASE_MASTER.FOLLOWUP_DATE_J, \n  PVA_STAGE.S_CASE_MASTER.INIT_REPT_DATE_J, \n  PVA_STAGE.S_CASE_MASTER.JUST_INIT_REPT_DATE_J, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_1_J, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_2_J, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_3_J, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_4_J, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_5_J, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_6_J, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_7_J, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_8_J, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_9_J, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_10_J, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_11_J, \n  PVA_STAGE.S_CASE_MASTER.UD_TEXT_12_J, \n  PVA_STAGE.S_CASE_MASTER.INITIAL_JUSTIFICATION_J, \n  PVA_STAGE.S_CASE_MASTER.DLP_REVISION_NUMBER, \n  PVA_STAGE.S_CASE_MASTER.REVISION_DELETE_FLAG, \n  PVA_STAGE.S_CASE_MASTER.DELETED_FLAG, \n PVA_STAGE.S_CASE_MASTER.EFFECTIVE_START_DATE, \n  PVA_STAGE.S_CASE_MASTER.EFFECTIVE_END_DATE\n" 	
				+"FROM PVA_STAGE.S_CASE_MASTER where rownum <=10"; //take only 10 records for testing purpose
			...
			while (rs_tOracleInput_1.next()) {
				...
				if (colQtyInRs_tOracleInput_1 < 1) {
					...
					if (rs_tOracleInput_1.getObject(1) != null) {
						row1.ENTERPRISE_ID = rs_tOracleInput_1
								.getBigDecimal(1);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 2) {
					...
					if (rs_tOracleInput_1.getObject(2) != null) {
						row1.CASE_ID = rs_tOracleInput_1
								.getBigDecimal(2);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 3) {
					...
					row1.CASE_NUM = routines.system.JDBCUtil.getString(
				...
				if (colQtyInRs_tOracleInput_1 < 4) {
					...
					if (rs_tOracleInput_1.getObject(4) != null) {
						row1.REV = rs_tOracleInput_1.getBigDecimal(4);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 5) {
					...
					if (rs_tOracleInput_1.getObject(5) != null) {
						row1.WORKFLOW_SEQ_NUM = rs_tOracleInput_1
								.getBigDecimal(5);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 6) {
					...
					if (rs_tOracleInput_1.getObject(6) != null) {
						row1.LAST_WORKFLOW_SEQ_NUM = rs_tOracleInput_1
								.getBigDecimal(6);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 7) {
					...
					row1.CREATE_TIME = routines.system.JDBCUtil
							.getDate(rs_tOracleInput_1, 7);
				}
				if (colQtyInRs_tOracleInput_1 < 8) {
					row1.INIT_REPT_DATE = null;
				} else {

					row1.INIT_REPT_DATE = routines.system.JDBCUtil
							.getDate(rs_tOracleInput_1, 8);
				}
				if (colQtyInRs_tOracleInput_1 < 9) {
					...
					if (rs_tOracleInput_1.getObject(9) != null) {
						row1.USER_ID = rs_tOracleInput_1
								.getBigDecimal(9);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 10) {
					...
					row1.LAST_UPDATE_TIME = routines.system.JDBCUtil
				...
				if (colQtyInRs_tOracleInput_1 < 11) {
					...
					if (rs_tOracleInput_1.getObject(11) != null) {
						row1.LAST_UPDATE_USER_ID = rs_tOracleInput_1
								.getBigDecimal(11);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 12) {
					...
					if (rs_tOracleInput_1.getObject(12) != null) {
						row1.REQUIRES_FOLLOWUP = rs_tOracleInput_1
								.getBigDecimal(12);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 13) {
					...
					row1.FOLLOWUP_DATE = routines.system.JDBCUtil
							.getDate(rs_tOracleInput_1, 13);
				}
				if (colQtyInRs_tOracleInput_1 < 14) {
					...
					if (rs_tOracleInput_1.getObject(14) != null) {
						row1.OWNER_ID = rs_tOracleInput_1
								.getBigDecimal(14);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 15) {
					...
					if (rs_tOracleInput_1.getObject(15) != null) {
						row1.STATE_ID = rs_tOracleInput_1
								.getBigDecimal(15);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 16) {
					...
					if (rs_tOracleInput_1.getObject(16) != null) {
						row1.COUNTRY_ID = rs_tOracleInput_1
								.getBigDecimal(16);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 17) {
					...
					if (rs_tOracleInput_1.getObject(17) != null) {
						row1.LANG_ID = rs_tOracleInput_1
								.getBigDecimal(17);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 18) {
					...
					if (rs_tOracleInput_1.getObject(18) != null) {
						row1.PRIORITY = rs_tOracleInput_1
								.getBigDecimal(18);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 19) {
					...
					if (rs_tOracleInput_1.getObject(19) != null) {
						row1.SITE_ID = rs_tOracleInput_1
								.getBigDecimal(19);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 20) {
					...
					if (rs_tOracleInput_1.getObject(20) != null) {
						row1.SERIOUSNESS = rs_tOracleInput_1
								.getBigDecimal(20);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 21) {
					...
					if (rs_tOracleInput_1.getObject(21) != null) {
						row1.RPT_TYPE_ID = rs_tOracleInput_1
								.getBigDecimal(21);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 22) {
					...
					if (rs_tOracleInput_1.getObject(22) != null) {
						row1.LAST_STATE_ID = rs_tOracleInput_1
								.getBigDecimal(22);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 23) {
					...
					if (rs_tOracleInput_1.getObject(23) != null) {
						row1.ASSESSMENT_NEEDED = rs_tOracleInput_1
								.getBigDecimal(23);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 24) {
					...
					if (rs_tOracleInput_1.getObject(24) != null) {
						row1.PRIORITY_OVERRIDE = rs_tOracleInput_1
								.getBigDecimal(24);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 25) {
					...
					row1.SID = routines.system.JDBCUtil.getString(
							rs_tOracleInput_1, 25, false);
				}
				if (colQtyInRs_tOracleInput_1 < 26) {
					row1.SAFETY_DATE = null;
				} else {

					row1.SAFETY_DATE = routines.system.JDBCUtil
							.getDate(rs_tOracleInput_1, 26);
				}
				if (colQtyInRs_tOracleInput_1 < 27) {
					row1.NORMAL_TIME = null;
				} else {

					row1.NORMAL_TIME = routines.system.JDBCUtil
							.getDate(rs_tOracleInput_1, 27);
				}
				if (colQtyInRs_tOracleInput_1 < 28) {
					row1.MAX_TIME = null;
				} else {

					row1.MAX_TIME = routines.system.JDBCUtil.getDate(
							rs_tOracleInput_1, 28);
				}
				if (colQtyInRs_tOracleInput_1 < 29) {
					...
					if (rs_tOracleInput_1.getObject(29) != null) {
						row1.REPORT_SCHEDULING = rs_tOracleInput_1
								.getBigDecimal(29);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 30) {
					...
					if (rs_tOracleInput_1.getObject(30) != null) {
						row1.PRIORITY_ASSESSMENT = rs_tOracleInput_1
								.getBigDecimal(30);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 31) {
					...
					if (rs_tOracleInput_1.getObject(31) != null) {
						row1.CLOSE_USER_ID = rs_tOracleInput_1
								.getBigDecimal(31);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 32) {
					...
					row1.CLOSE_DATE = routines.system.JDBCUtil.getDate(
							rs_tOracleInput_1, 32);
				}
				if (colQtyInRs_tOracleInput_1 < 33) {
					row1.CLOSE_NOTES = null;
				} else {

					row1.CLOSE_NOTES = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 33, false);
				}
				if (colQtyInRs_tOracleInput_1 < 34) {
					row1.DATE_LOCKED = null;
				} else {

					row1.DATE_LOCKED = routines.system.JDBCUtil
							.getDate(rs_tOracleInput_1, 34);
				}
				if (colQtyInRs_tOracleInput_1 < 35) {
					row1.UD_TEXT_1 = null;
				} else {

					row1.UD_TEXT_1 = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 35, false);
				}
				if (colQtyInRs_tOracleInput_1 < 36) {
					row1.UD_TEXT_2 = null;
				} else {

					row1.UD_TEXT_2 = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 36, false);
				}
				if (colQtyInRs_tOracleInput_1 < 37) {
					row1.UD_TEXT_3 = null;
				} else {

					row1.UD_TEXT_3 = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 37, false);
				}
				if (colQtyInRs_tOracleInput_1 < 38) {
					row1.UD_TEXT_4 = null;
				} else {

					row1.UD_TEXT_4 = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 38, false);
				}
				if (colQtyInRs_tOracleInput_1 < 39) {
					row1.UD_TEXT_5 = null;
				} else {

					row1.UD_TEXT_5 = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 39, false);
				}
				if (colQtyInRs_tOracleInput_1 < 40) {
					row1.UD_TEXT_6 = null;
				} else {

					row1.UD_TEXT_6 = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 40, false);
				}
				if (colQtyInRs_tOracleInput_1 < 41) {
					row1.UD_TEXT_7 = null;
				} else {

					row1.UD_TEXT_7 = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 41, false);
				}
				if (colQtyInRs_tOracleInput_1 < 42) {
					row1.UD_TEXT_8 = null;
				} else {

					row1.UD_TEXT_8 = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 42, false);
				}
				if (colQtyInRs_tOracleInput_1 < 43) {
					row1.UD_TEXT_9 = null;
				} else {

					row1.UD_TEXT_9 = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 43, false);
				}
				if (colQtyInRs_tOracleInput_1 < 44) {
					row1.UD_TEXT_10 = null;
				} else {

					row1.UD_TEXT_10 = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 44, false);
				}
				if (colQtyInRs_tOracleInput_1 < 45) {
					row1.UD_TEXT_11 = null;
				} else {

					row1.UD_TEXT_11 = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 45, false);
				}
				if (colQtyInRs_tOracleInput_1 < 46) {
					row1.UD_TEXT_12 = null;
				} else {

					row1.UD_TEXT_12 = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 46, false);
				}
				if (colQtyInRs_tOracleInput_1 < 47) {
					row1.UD_DATE_1 = null;
				} else {

					row1.UD_DATE_1 = routines.system.JDBCUtil.getDate(
							rs_tOracleInput_1, 47);
				}
				if (colQtyInRs_tOracleInput_1 < 48) {
					row1.UD_DATE_2 = null;
				} else {

					row1.UD_DATE_2 = routines.system.JDBCUtil.getDate(
							rs_tOracleInput_1, 48);
				}
				if (colQtyInRs_tOracleInput_1 < 49) {
					row1.UD_DATE_3 = null;
				} else {

					row1.UD_DATE_3 = routines.system.JDBCUtil.getDate(
							rs_tOracleInput_1, 49);
				}
				if (colQtyInRs_tOracleInput_1 < 50) {
					row1.UD_DATE_4 = null;
				} else {

					row1.UD_DATE_4 = routines.system.JDBCUtil.getDate(
							rs_tOracleInput_1, 50);
				}
				if (colQtyInRs_tOracleInput_1 < 51) {
					row1.UD_DATE_5 = null;
				} else {

					row1.UD_DATE_5 = routines.system.JDBCUtil.getDate(
							rs_tOracleInput_1, 51);
				}
				if (colQtyInRs_tOracleInput_1 < 52) {
					row1.UD_DATE_6 = null;
				} else {

					row1.UD_DATE_6 = routines.system.JDBCUtil.getDate(
							rs_tOracleInput_1, 52);
				}
				if (colQtyInRs_tOracleInput_1 < 53) {
					row1.UD_DATE_7 = null;
				} else {

					row1.UD_DATE_7 = routines.system.JDBCUtil.getDate(
							rs_tOracleInput_1, 53);
				}
				if (colQtyInRs_tOracleInput_1 < 54) {
					row1.UD_DATE_8 = null;
				} else {

					row1.UD_DATE_8 = routines.system.JDBCUtil.getDate(
							rs_tOracleInput_1, 54);
				}
				if (colQtyInRs_tOracleInput_1 < 55) {
					row1.UD_DATE_9 = null;
				} else {

					row1.UD_DATE_9 = routines.system.JDBCUtil.getDate(
							rs_tOracleInput_1, 55);
				}
				if (colQtyInRs_tOracleInput_1 < 56) {
					row1.UD_DATE_10 = null;
				} else {

					row1.UD_DATE_10 = routines.system.JDBCUtil.getDate(
							rs_tOracleInput_1, 56);
				}
				if (colQtyInRs_tOracleInput_1 < 57) {
					row1.UD_DATE_11 = null;
				} else {

					row1.UD_DATE_11 = routines.system.JDBCUtil.getDate(
							rs_tOracleInput_1, 57);
				}
				if (colQtyInRs_tOracleInput_1 < 58) {
					row1.UD_DATE_12 = null;
				} else {

					row1.UD_DATE_12 = routines.system.JDBCUtil.getDate(
							rs_tOracleInput_1, 58);
				}
				if (colQtyInRs_tOracleInput_1 < 59) {
					...
					if (rs_tOracleInput_1.getObject(59) != null) {
						row1.UD_NUMBER_1 = rs_tOracleInput_1
								.getBigDecimal(59);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 60) {
					...
					if (rs_tOracleInput_1.getObject(60) != null) {
						row1.UD_NUMBER_2 = rs_tOracleInput_1
								.getBigDecimal(60);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 61) {
					...
					if (rs_tOracleInput_1.getObject(61) != null) {
						row1.UD_NUMBER_3 = rs_tOracleInput_1
								.getBigDecimal(61);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 62) {
					...
					if (rs_tOracleInput_1.getObject(62) != null) {
						row1.UD_NUMBER_4 = rs_tOracleInput_1
								.getBigDecimal(62);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 63) {
					...
					if (rs_tOracleInput_1.getObject(63) != null) {
						row1.UD_NUMBER_5 = rs_tOracleInput_1
								.getBigDecimal(63);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 64) {
					...
					if (rs_tOracleInput_1.getObject(64) != null) {
						row1.UD_NUMBER_6 = rs_tOracleInput_1
								.getBigDecimal(64);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 65) {
					...
					if (rs_tOracleInput_1.getObject(65) != null) {
						row1.UD_NUMBER_7 = rs_tOracleInput_1
								.getBigDecimal(65);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 66) {
					...
					if (rs_tOracleInput_1.getObject(66) != null) {
						row1.UD_NUMBER_8 = rs_tOracleInput_1
								.getBigDecimal(66);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 67) {
					...
					if (rs_tOracleInput_1.getObject(67) != null) {
						row1.UD_NUMBER_9 = rs_tOracleInput_1
								.getBigDecimal(67);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 68) {
					...
					if (rs_tOracleInput_1.getObject(68) != null) {
						row1.UD_NUMBER_10 = rs_tOracleInput_1
								.getBigDecimal(68);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 69) {
					...
					if (rs_tOracleInput_1.getObject(69) != null) {
						row1.UD_NUMBER_11 = rs_tOracleInput_1
								.getBigDecimal(69);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 70) {
					...
					if (rs_tOracleInput_1.getObject(70) != null) {
						row1.UD_NUMBER_12 = rs_tOracleInput_1
								.getBigDecimal(70);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 71) {
					...
					row1.DELETED = routines.system.JDBCUtil.getDate(
							rs_tOracleInput_1, 71);
				}
				if (colQtyInRs_tOracleInput_1 < 72) {
					row1.DUE_SOON = null;
				} else {

					row1.DUE_SOON = routines.system.JDBCUtil.getDate(
							rs_tOracleInput_1, 72);
				}
				if (colQtyInRs_tOracleInput_1 < 73) {
					row1.GLOBAL_NUM = null;
				} else {

					row1.GLOBAL_NUM = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 73, false);
				}
				if (colQtyInRs_tOracleInput_1 < 74) {
					row1.PRIORITY_DATE_ASSESSED = null;
				} else {

					row1.PRIORITY_DATE_ASSESSED = routines.system.JDBCUtil
							.getDate(rs_tOracleInput_1, 74);
				}
				if (colQtyInRs_tOracleInput_1 < 75) {
					row1.LAM_ASSESS_DONE = null;
				} else {

					if (rs_tOracleInput_1.getObject(75) != null) {
						row1.LAM_ASSESS_DONE = rs_tOracleInput_1
								.getBigDecimal(75);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 76) {
					...
					row1.E2B_WW_NUMBER = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 76, false);
				}
				if (colQtyInRs_tOracleInput_1 < 77) {
					...
					if (rs_tOracleInput_1.getObject(77) != null) {
						row1.WORKLIST_OWNER_ID = rs_tOracleInput_1
								.getBigDecimal(77);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 78) {
					...
					if (rs_tOracleInput_1.getObject(78) != null) {
						row1.SUSAR = rs_tOracleInput_1
								.getBigDecimal(78);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 79) {
					...
					row1.LAST_UPDATE_EVENT = routines.system.JDBCUtil
							.getDate(rs_tOracleInput_1, 79);
				}
				if (colQtyInRs_tOracleInput_1 < 80) {
					row1.INITIAL_JUSTIFICATION = null;
				} else {

					row1.INITIAL_JUSTIFICATION = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 80, false);
				}
				if (colQtyInRs_tOracleInput_1 < 81) {
					row1.FORCE_SOON = null;
				} else {

					row1.FORCE_SOON = routines.system.JDBCUtil.getDate(
							rs_tOracleInput_1, 81);
				}
				if (colQtyInRs_tOracleInput_1 < 82) {
					row1.DUE_SOON_J = null;
				} else {

					row1.DUE_SOON_J = routines.system.JDBCUtil.getDate(
							rs_tOracleInput_1, 82);
				}
				if (colQtyInRs_tOracleInput_1 < 83) {
					row1.FOLLOWUP_DATE_J = null;
				} else {

					row1.FOLLOWUP_DATE_J = routines.system.JDBCUtil
							.getDate(rs_tOracleInput_1, 83);
				}
				if (colQtyInRs_tOracleInput_1 < 84) {
					row1.INIT_REPT_DATE_J = null;
				} else {

					row1.INIT_REPT_DATE_J = routines.system.JDBCUtil
							.getDate(rs_tOracleInput_1, 84);
				}
				if (colQtyInRs_tOracleInput_1 < 85) {
					row1.JUST_INIT_REPT_DATE_J = null;
				} else {

					row1.JUST_INIT_REPT_DATE_J = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 85, false);
				}
				if (colQtyInRs_tOracleInput_1 < 86) {
					row1.UD_TEXT_1_J = null;
				} else {

					row1.UD_TEXT_1_J = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 86, false);
				}
				if (colQtyInRs_tOracleInput_1 < 87) {
					row1.UD_TEXT_2_J = null;
				} else {

					row1.UD_TEXT_2_J = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 87, false);
				}
				if (colQtyInRs_tOracleInput_1 < 88) {
					row1.UD_TEXT_3_J = null;
				} else {

					row1.UD_TEXT_3_J = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 88, false);
				}
				if (colQtyInRs_tOracleInput_1 < 89) {
					row1.UD_TEXT_4_J = null;
				} else {

					row1.UD_TEXT_4_J = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 89, false);
				}
				if (colQtyInRs_tOracleInput_1 < 90) {
					row1.UD_TEXT_5_J = null;
				} else {

					row1.UD_TEXT_5_J = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 90, false);
				}
				if (colQtyInRs_tOracleInput_1 < 91) {
					row1.UD_TEXT_6_J = null;
				} else {

					row1.UD_TEXT_6_J = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 91, false);
				}
				if (colQtyInRs_tOracleInput_1 < 92) {
					row1.UD_TEXT_7_J = null;
				} else {

					row1.UD_TEXT_7_J = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 92, false);
				}
				if (colQtyInRs_tOracleInput_1 < 93) {
					row1.UD_TEXT_8_J = null;
				} else {

					row1.UD_TEXT_8_J = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 93, false);
				}
				if (colQtyInRs_tOracleInput_1 < 94) {
					row1.UD_TEXT_9_J = null;
				} else {

					row1.UD_TEXT_9_J = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 94, false);
				}
				if (colQtyInRs_tOracleInput_1 < 95) {
					row1.UD_TEXT_10_J = null;
				} else {

					row1.UD_TEXT_10_J = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 95, false);
				}
				if (colQtyInRs_tOracleInput_1 < 96) {
					row1.UD_TEXT_11_J = null;
				} else {

					row1.UD_TEXT_11_J = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 96, false);
				}
				if (colQtyInRs_tOracleInput_1 < 97) {
					row1.UD_TEXT_12_J = null;
				} else {

					row1.UD_TEXT_12_J = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 97, false);
				}
				if (colQtyInRs_tOracleInput_1 < 98) {
					row1.INITIAL_JUSTIFICATION_J = null;
				} else {

					row1.INITIAL_JUSTIFICATION_J = routines.system.JDBCUtil
							.getString(rs_tOracleInput_1, 98, false);
				}
				if (colQtyInRs_tOracleInput_1 < 99) {
					row1.DLP_REVISION_NUMBER = null;
				} else {

					if (rs_tOracleInput_1.getObject(99) != null) {
						row1.DLP_REVISION_NUMBER = rs_tOracleInput_1
								.getBigDecimal(99);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 100) {
					row1.REVISION_DELETE_FLAG = null;
				} else {

					if (rs_tOracleInput_1.getObject(100) != null) {
						row1.REVISION_DELETE_FLAG = rs_tOracleInput_1
								.getBigDecimal(100);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 101) {
					row1.DELETED_FLAG = null;
				} else {

					if (rs_tOracleInput_1.getObject(101) != null) {
						row1.DELETED_FLAG = rs_tOracleInput_1
								.getBigDecimal(101);
					} else {
				...
				if (colQtyInRs_tOracleInput_1 < 102) {
					row1.EFFECTIVE_START_DATE = null;
				} else {

					row1.EFFECTIVE_START_DATE = routines.system.JDBCUtil
							.getDate(rs_tOracleInput_1, 102);
				}
				if (colQtyInRs_tOracleInput_1 < 103) {
					row1.EFFECTIVE_END_DATE = null;
				} else {

					row1.EFFECTIVE_END_DATE = routines.system.JDBCUtil
							.getDate(rs_tOracleInput_1, 103);
				}
				
				//Publishing DB records to Kafka
				producer.send(new ProducerRecord<String,row1Struct>(TOPIC_NAME,row1));
				 System.out.println("Published Message " + row1.toString() + " sent !!");
			}
	...
	public java.sql.Statement prepareSourcedb()
	{
		...
		url_tOracleInput_1 = "jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host="+ "10.100.6.23"+ ")(port="+ "1521"+ "))(connect_data=(service_name=" + "PVMARRS2" + ")))";

		String dbUser_tOracleInput_1 = "PVA_STAGE";

		final String decryptedPassword_tOracleInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("568eb830737d4d92");
